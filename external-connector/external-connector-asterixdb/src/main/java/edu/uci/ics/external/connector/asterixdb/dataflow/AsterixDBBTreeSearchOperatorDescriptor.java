...
public class AsterixDBBTreeSearchOperatorDescriptor extends AbstractTreeIndexOperatorDescriptor {
    ...
    public AsterixDBBTreeSearchOperatorDescriptor(IOperatorDescriptorRegistry spec, RecordDescriptor recDesc,
        ...
        super(spec, 1, 1, recDesc, storageManager, lifecycleManagerProvider, fileSplitProvider, typeTraits,
                ...
                nullWriterFactory, new TransientLocalResourceFactoryProvider(), searchOpCallbackProvider,
