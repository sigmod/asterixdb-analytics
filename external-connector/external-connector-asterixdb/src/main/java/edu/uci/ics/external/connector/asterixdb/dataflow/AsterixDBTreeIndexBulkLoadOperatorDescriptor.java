...
public class AsterixDBTreeIndexBulkLoadOperatorDescriptor extends AbstractTreeIndexOperatorDescriptor {
    ...
    public AsterixDBTreeIndexBulkLoadOperatorDescriptor(IOperatorDescriptorRegistry spec, RecordDescriptor recDesc,
