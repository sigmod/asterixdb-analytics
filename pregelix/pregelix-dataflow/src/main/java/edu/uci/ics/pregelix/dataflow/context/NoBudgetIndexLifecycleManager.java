...
public class NoBudgetIndexLifecycleManager implements IIndexLifecycleManager, ILifeCycleComponent {
    ...
    @Override
    public IIndex getIndex(String resourceName) {
    ...
    public void register(String resourceName, IIndex index) throws HyracksDataException {
        if (indexInfos.containsKey(resourceName)) {
            throw new HyracksDataException("Index with resource ID " + resourceName + " already exists.");
        }
    ...
    public void unregister(String resourceName) throws HyracksDataException {
        IndexInfo info = indexInfos.remove(resourceName);
        if (info == null) {
            throw new HyracksDataException("Index with resource ID " + resourceName + " does not exist.");
        }
    ...
    public void open(String resourceName) throws HyracksDataException {
        ...
        if (info == null) {
            throw new HyracksDataException(
                    "Failed to open index with resource ID " + resourceName + " since it does not exist.");
        }
    ...
    @Override
    public void close(String resourceName) {
